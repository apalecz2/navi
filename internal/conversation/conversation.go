...
// every conversations row a turn produces, and reading the device timezone
// for the system prompt's injected context - the same live lookup
// agent.Tools' own resolveCreateZone makes, so there is nothing to cache and
// nothing to drift.
